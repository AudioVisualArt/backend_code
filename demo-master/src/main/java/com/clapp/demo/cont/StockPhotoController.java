...
public class StockPhotoController {
	...
	public List<StockPhoto> getAllWorkers() throws InterruptedException, ExecutionException {
	...
	public String saveProject(@RequestBody StockPhoto photo) {
	...
	public String updateProject (@PathVariable String photoId, @RequestBody StockPhoto photo) {
	...
	public String deleteProject (@PathVariable String photoId ) {
	...
	public StockPhoto getProduct (@PathVariable String photoId) {
